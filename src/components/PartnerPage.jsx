  ...
  return (
    <div className="home-container" id="main-container">
      ...
      <section class="prt-partnership-section">
        <h2><TextSlideUp>Partnership Opportunity for Everyone</TextSlideUp></h2>
        <div class="prt-card-container">
          <div class="prt-card">
            <div class="prt-card-icon">
              <img src={bx} alt="Product Partner" />
            </div>
            <h3><TextSlideUp>Product Partner</TextSlideUp></h3>
            <p>
            <TextFadeIn defaultValue='Our Product partnership enables open-source partners to present
          ...
          <div class="prt-card">
            ...
            <h3><TextSlideUp>Cloud Partner</TextSlideUp></h3>
            <p>
            <TextFadeIn defaultValue='Our Cloud Partnership enables providers to offer their server
          ...
          <div class="prt-card">
            ...
            <h3><TextSlideUp>Expertise Partner</TextSlideUp></h3>
            <p>
            <TextFadeIn defaultValue='Our Expertise Partnership allows product experts to collaborate
        ...
        <div class="prd-card-container">
          ...
          <div class="prd-partnership-card">
            <div class="prd-card-content">
              <h3><TextSlideUp>Product Partnership</TextSlideUp></h3>
              <p>
            ...
            <div class="prd-video-container">
              {wistiaVideos.map((video) => (
                <div
                  key={video.id}
                  className={`wistia_embed wistia_async_${video.id} video-overlay`}
                />
              ))}
              <img
                src="https://s3-alpha-sig.figma.com/img/5b18/238b/2a9a13a539e463a8b241639c73be1b5e?Expires=1725235200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=i3~ihKEnkpylDQgxe2kKL~sXlIrV8t7oNfHYOBgyOmTdxEHlGtGNUcnvsp61l7oGXFZ-EMW9tejjTEAlM61PxC7bbFSoqYEkwVuDoSTKhVBpOS~-V5~hpeRDu4zysrsPQAfxmvR5Ms1gJXSObqi--8AOa6eDdXmu~wzyMSueeuYFqqlR1nILnDe~jCK2lr9vNAqcTfkAf~L-LtWhPdEG5jEuWCkQFH~M7Wn8wLxmMIb3pEylMvHn7zFWGDZbbaUUMkLILMM4fTCGT-EJTbTR0n5O7z7x5qmQO0RQEpdTOFFXzMqwzBCIAp3OMdRda6olhXcfA6sEBntLjebPyOhVvw__"
                alt="Expertise Partnership Image"
              />
              <div class="prd-play-button">&#9658;</div>
            </div>
          </div>
          ...
          <div class="prd-partnership-card prd-reverse">
            <div class="prd-card-content">
              <h3><TextSlideUp>Cloud Partnership</TextSlideUp></h3>
              <p>
              <TextFadeIn defaultValue='Welcome to [Company Name], where innovation meets excellence in
              ...
              <p>
              <TextFadeIn defaultValue='With our expertise in cloud computing, we help organizations of
          ...
          <div class="prd-partnership-card">
            <div class="prd-card-content">
              <h3><TextSlideUp>Expertise Partnership</TextSlideUp></h3>
              <p>
              <TextFadeIn defaultValue='Welcome to [Company Name], where we bring together expertise and
              ...
              <p>
              <TextFadeIn defaultValue='With our deep knowledge of the latest technological trends, we
